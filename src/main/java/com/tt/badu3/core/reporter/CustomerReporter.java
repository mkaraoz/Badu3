 ...
 * @author mk
 */
public class CustomerReporter extends BaseReporter
{
    private static final String MASTER_DOC_PATH = ".\\base\\masterDH.docx";
    ...
    private void writeVulnerabilities()
    {
        ...
        final int TANIM_ROW = 4;
        final int COZUM_ROW = 6;
        final int EK_ROW = 7;
        final int DATA_COL = 1;

        Badu.log().info("ZAFIYET_TABLOSU: " + ZAFIYET_TABLOSU);
        XWPFTable table = getTable(ZAFIYET_TABLOSU);
        int currentIndex = 7;
